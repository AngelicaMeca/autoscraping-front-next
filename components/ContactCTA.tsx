...
export default function ContactCTA({ sectionClassName }: { sectionClassName?: string }) {
  const t = useTranslation();
  const lang = useLang();
  const c = t.contactCta;

  return (
    <section className={`relative py-16 md:py-32 overflow-hidden ${sectionClassName ?? 'bg-white -mt-16'}`}>
