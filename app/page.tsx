...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-gray-50 via-purple-50/30 to-blue-50/20 py-24 pb-64 overflow-hidden">
                ...
                {teamMembers.map((_, idx) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all ${
                      idx === teamSlide ? 'bg-white' : 'bg-white/30'
                    }`}
                  />
                ))}
              </div>
